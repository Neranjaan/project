...
<h1 className="display-4 text-center" style={{fontFamily:"Arial Black" }}>Interesting facts about the earth</h1>
<br></br>
<p className="text-center" style={{fontFamily:"Bahnschrift SemiBold"}}>The Earth’s rotation is gradually slowing.
...
This varies according to the part of the planet; for example, the metallic core is denser than the crust. The average density of the Earth is approximately 5.52 grams per cubic centimetre.</p>
